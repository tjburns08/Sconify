...
plot.tsne(wand.final, "IgM(Eu153)Di", "Raw IgM expression")
plot.tsne(wand.final, "IL7.fraction.cond.2", "Fraction cells in Il7 condition")
...
plot.tsne(bz.gmcsf.final, "fraction.cond2", "Fraction GM-CSF")

# t-SNE map colored by KNN-based fraction GM-CSF
plot.tsne(bz.gmcsf.final.norm.scale, "fraction.cond2", "Fraction GM-CSF")
```
