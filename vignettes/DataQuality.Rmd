...
condition, shown below. The dataset we use is the Wanderlust dataset (paper: https://www.ncbi.nlm.nih.gov/pubmed/24766814, dataset: https://www.c2b2.columbia.edu/danapeerlab/html/wanderlust-data.html), between 
a single normal and IL-7 treated patient. 
...
sd = 0.5/sqrt(k). This is derived from the DeMoivre-Laplace theorem (https://en.wikipedia.org/wiki/De_Moivre%E2%80%93Laplace_theorem). This means 
...
introduce untreated and treated data from the initial Nolan Lab barcoding paper (https://www.ncbi.nlm.nih.gov/pubmed/22902532). This dataset was produced when 
...
as acquired on a CyTOF 1 Mass Cytometer prior to bead-based normalization (https://www.ncbi.nlm.nih.gov/pubmed/23512433), so we hypothesize that this 
