...
tsne.vis(wand.final, "pSTAT5(Nd150)Di.IL7.change", "IL7 -> pSTAT5 change")

# tSNE map now colored by q value
tsne.vis(wand.final, "pSTAT5(Nd150)Di.IL7.qvalue", "IL7 -> pSTAT5 -log10(qvalue)")

# tSNE map colored by KNN density estimation
tsne.vis(wand.final, "density")
...
```{r}
wand.final.sub <- subsample.and.tsne(dat = wand.final, input = input.markers, numcells = 500)
wand.final.sub
```
