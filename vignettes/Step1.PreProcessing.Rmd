...
wand.combined <- ProcessMultipleFiles(files = c(basal, il7), input = surface, numcells = 1000)
wand.combined
...
wand.basal <- ProcessMultipleFiles(files = basal, numcells = 1000, scale = TRUE, input = surface)
wand.basal
